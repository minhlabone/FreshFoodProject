...
public class RauCuAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    @NonNull
    @Override
    // nếu là view data thì hiển thi item còn ko thì hiển thị loading
...
//           Glide.with(context).load(sanPham.getHinhanh()).into(myViewHolder.hinhanh);
           if(sanPham.getHinhanh().contains("http")){
               ...
               Glide.with(context).load(Utils.BASE_URL + "images/" + sanPham.getHinhanh()).into(myViewHolder.hinhanh);
           }
  ...
  // nếu khồng có thì loading data nếu có dữ liệu thì hiển thị item
    @Override
